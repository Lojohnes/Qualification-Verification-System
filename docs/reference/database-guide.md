...
- Institution: `organizations`, `institutions`, `faculties`, `departments`, `programs`.
- Qualification: `students`, `qualifications`, `qualification_status_history`, `csv_import_batches`.
- Document: `certificate_templates`, `certificates`, `document_storage_objects`, `qr_records`, `digital_signatures`.
